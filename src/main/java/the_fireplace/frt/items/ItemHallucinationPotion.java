        ...
        if (!worldIn.isRemote) {
            switch (stack.getItemDamage()) {
                case 0:
                    ...
                    PacketDispatcher.sendTo(new UpdatePotionMessage(3600), (EntityPlayerMP)entityplayer);
                case 1:
                    entityLiving.addPotionEffect(new PotionEffect(FRT.hallucination, 9600));
                    PacketDispatcher.sendTo(new UpdatePotionMessage(9600), (EntityPlayerMP)entityplayer);
                default:
                    break;
            }
        }
