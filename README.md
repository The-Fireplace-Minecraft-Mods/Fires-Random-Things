...
[Issue Reporting](https://github.com/The-Fireplace/Fires-Random-Things/issues)
------------------------------------------------------------------

If you found a bug or even are experiencing a crash please report it so we can fix it. Please check at first if a bug report for the issue already
[exists](https://github.com/The-Fireplace/Fires-Random-Things/issues). If not just create a [new issue](https://github.com/The-Fireplace/Fires-Random-Things/issues/new) and fill out the
form.
...
[Feature Requests](https://github.com/The-Fireplace/Fires-Random-Things/issues)
-------------------------------------------------------------------

If you want a new feature added, go ahead an open a [new issue](https://github.com/The-Fireplace/Fires-Random-Things/issues/new), remove the existing form and describe your
...
So all you have to do to include the mod is add these lines *(in the appropriate places)* to your build.gradle
    ...
    dependencies {
        deobfCompile "the_fireplace.frt:FiresRandomThings-<MC-Version>:<version>"
        // Other dependencies
    }
